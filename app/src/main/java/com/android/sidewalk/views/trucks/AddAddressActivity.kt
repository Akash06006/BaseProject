...
import com.android.sidewalk.databinding.ActivityAddAddressBinding
...
class AddAddressActivity : BaseActivity(), OnMapReadyCallback, LocationListener,
    ...
    lateinit var addressViewModel : TrucksViewModel
    ...
    override fun initViews() {
        ...
        addressViewModel = ViewModelProviders.of(this).get(TrucksViewModel::class.java)
        addressBinding.truckViewModel = addressViewModel
