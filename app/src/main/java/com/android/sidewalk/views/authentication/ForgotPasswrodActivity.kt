...
import com.android.sidewalk.viewmodels.ForgotPasswordModel
import com.google.gson.JsonObject
import com.android.sidewalk.databinding.ActivityForgotPasswordBinding
...
class ForgotPasswrodActivity : BaseActivity() {
    ...
    override fun initViews() {
        ...
        forgotPasswordModel = ViewModelProviders.of(this)
            .get(ForgotPasswordModel::class.java)
            ...
            Observer<LoginResponse> { forgotResponse->
                ...
                if (forgotResponse != null) {
                    ...
                    if (forgotResponse.code == 200) {
                        ...
                        val intent = Intent(
                            this,
                            ResetPasswrodActivity::class.java
                        )
