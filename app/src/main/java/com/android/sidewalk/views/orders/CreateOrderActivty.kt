package com.android.sidewalk.views.orders
...
import com.android.sidewalk.adapters.orders.DiscountListAdapter
import com.android.sidewalk.adapters.orders.VehiclesListAdapter
import com.android.sidewalk.adapters.orders.WeightListAdapter
...
import com.android.sidewalk.viewmodels.order.OrderViewModel
import com.android.sidewalk.databinding.ActivityCreateOrderBinding
...
class CreateOrderActivty : BaseActivity() {
    ...
    var vehicleList =
        ArrayList<ListsResponse.VehicleData>()
    var weightList =
        ArrayList<ListsResponse.WeightData>()
    var vehiclesAdapter : VehiclesListAdapter? =
        null
    var weightAdapter : WeightListAdapter? =
        null
