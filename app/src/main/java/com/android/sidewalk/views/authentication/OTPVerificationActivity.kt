...
import com.android.sidewalk.viewmodels.OTPVerificationModel
import com.android.sidewalk.databinding.ActivityOtpVerificationBinding
...
class OTPVerificationActivity : BaseActivity() {
    ...
    public override fun initViews() {
        ...
        token = SharedPrefClass()
            .getPrefValue(
                this,
                GlobalConstants.ACCESS_TOKEN
            ).toString()

        otpVerificationModel = ViewModelProviders.of(this)
            .get(OTPVerificationModel::class.java)
