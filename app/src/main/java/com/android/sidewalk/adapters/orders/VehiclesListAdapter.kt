...
import com.android.sidewalk.databinding.VehicleWeightItemBinding
...
class VehiclesListAdapter(
    ...
    private var viewHolder : VehiclesListAdapter.ViewHolder? =
        null
    ...
    override fun onBindViewHolder(
        @NonNull holder : VehiclesListAdapter.ViewHolder,
        position : Int
    ) {
        viewHolder = holder
        val dis = (position + 1)
