package com.android.sidewalk.adapters.orders
...
import com.android.sidewalk.databinding.DiscountItemBinding
import com.android.sidewalk.model.DiscountModel
import com.android.sidewalk.views.orders.CreateOrderActivty
...
class DiscountListAdapter(
    ...
    override fun onBindViewHolder(@NonNull holder : DiscountListAdapter.ViewHolder, position : Int) {
        viewHolder = holder
