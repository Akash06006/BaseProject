...
import com.android.sidewalk.repositories.ForgotPasswordRepository
...
class OTPVerificationModel : BaseViewModel() {
    ...
    private var data : MutableLiveData<CommonModel>? =
        null
    private var resendResponse : MutableLiveData<CommonModel>? =
        null
    private var forgotPasswordRepository =
