package com.android.sidewalk.maps
...
class MapClass : OnMapReadyCallback, GoogleMap.OnCameraIdleListener,
    ...
    private val mUpdatePlaceDetailsCallback = OnCompleteListener<PlaceBufferResponse> { task->
        try {
            ...
            Log.i(
                TAG,
                "Place details received: " + place.name
            )
    ...
    fun setUpPlaceAutoComplete(
        ...
        if (mAutocompleteView != null) {
            ...
            mAdapter = PlaceAutocompleteAdapter(
                mContext,
                mGeoDataClient!!,
                mBounds,
                mFilter
            ...
            mAutocompleteView.setAdapter<PlaceAutocompleteAdapter>(
                mAdapter
            )
        }
    }
